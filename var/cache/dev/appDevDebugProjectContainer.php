...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7HwbTK00Lm', 0, 'JOyYqMkK9-tcNrwgl90RVo', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'keep_open' => false, 'items' => array(0 => array('admin' => 'admin.category', 'label' => 'Category', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'admin.blog_post', 'label' => 'Blog post', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
        $instance->setAdminClasses(array('App1Bundle\\Document\\Category' => array(0 => 'admin.category'), 'App1Bundle\\Document\\BlogPost' => array(0 => 'admin.blog_post')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A-2MaAvTEJ', 0, 'JOyYqMkK9-tcNrwgl90RVo', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
